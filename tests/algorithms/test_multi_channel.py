...
from benchmark_generate.scenarios import multi_resource_motifs, random_multi_resource_instance
...
from dag_heuristic.core.conversion import to_multi_resource_instance
...
def test_real_route_snapshots_preserve_resource_conflicts() -> None:
    root = ROOT / "benchmark/multi_channel/multi_resource_dag/real"

...
from dag_heuristic.benchmark.model import Benchmark
...
def validation_errors(benchmark: Benchmark) -> list[str]:
    ...
    if benchmark.scenario == "multi_channel" and benchmark.family != "multi_resource_dag":
        errors.append("multi_channel requires family=multi_resource_dag")
    return errors

...
from dag_heuristic.core.dag import BenchmarkDAG, BenchTask
...
def to_multi_resource_instance(benchmark: Benchmark):
    ...
    if benchmark.scenario != "multi_channel":
        raise ValueError(f"expected multi_channel, got {benchmark.scenario}")
    resources = {

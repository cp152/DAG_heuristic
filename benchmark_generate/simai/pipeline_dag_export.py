...
Usage:
    python -m benchmark_generate.simai.pipeline_dag_export
    python -m benchmark_generate.simai.pipeline_dag_export --modes 1f1b zero_bubble
"""
...
def write_report(
    ...
    text = [header, ""]
    text.append(
        "- 生成：`python -m benchmark_generate.simai.pipeline_dag_export`"
...
def main() -> None:
    ...
    report_path = DAG_ROOT / args.report
    if results:

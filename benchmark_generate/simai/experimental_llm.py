...
from benchmark_generate.simai._bootstrap import DAG_ROOT  # noqa: E402

from dag_heuristic.core.dag import _Builder
from benchmark_generate.simai.workload_adapter import build_route_aware_probe
from dag_heuristic.algorithms.multi_channel.solver import (
...
from benchmark_generate.simai.legacy_multiresource import MultiResourceInstance
from benchmark_generate.simai.topology_fixtures import (
    PLACEMENTS,
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=DAG_ROOT / "outputs/nonpreemptive_llm_structured/r5_summary.json",
    )

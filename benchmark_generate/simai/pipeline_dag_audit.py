...
from benchmark_generate.simai.pipeline_dag_export import (
    MODES,
    MODE_LABEL,
    stage_by_node,
)
...
def main() -> None:
    ...
    for mode in args.modes:
        ...
        if mode == args.timeline_mode:
            timeline_result = validate_timeline(built, graph, SIMAI_ROOT / args.topology)
